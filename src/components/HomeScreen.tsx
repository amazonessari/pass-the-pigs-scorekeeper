      ...
      {recentGames.length > 0 && (
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-display text-foreground">Recent Games</h2>
          </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={cn(
                        ...
                        game.status === 'complete' ? 'bg-success/20' : 'bg-primary/20'
                      )}>
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground flex items-center gap-2">
                          ...
                          {winner && (
                            <>
                              <span>•</span>
                              <span className="text-success">{winner} won!</span>
                            </>
                          )}
                          {game.status === 'active' && (
                            <>
